...
export function IconStar({ className = "w-5 h-5", filled = false }: { className?: string; filled?: boolean }) {
  return filled ? (
...
export function IconSync({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function IconDrive({ className = "w-5 h-5" }: { className?: string }) {
  return (
...
export function IconMicrosoft({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24">
...
export function IconWise({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
